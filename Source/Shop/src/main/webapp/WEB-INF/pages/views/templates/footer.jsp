							...
							<div class="box pav-newsletter-social">
								<ul>
									<li class="blue"><a data-original-title="Facebook"
										...
										href="https://www.facebook.com${ContractInformation.fbAddress }"
										title=""><i class="fa fa-facebook">&nbsp;</i></a></li>
									<li class="sky"><a data-original-title="Twitter"
										data-toggle="tooltip"
										href="https://twitter.com${ContractInformation.twtAddress }"
							...
							<div class="box-content">
								<ul class="list bullet text-fill">
									...
									<li><a href="../view/category" data-hover="Sản phẩm">Sản
											phẩm</a></li>
									<li><a href="../view/news" data-hover="Tin tức">Tin
											tức</a></li>
						...
						<div class="box customer-service">
							...
							<div class="box-content">
								<ul class="list bullet text-fill">
									...
									%>
									<li><a
										href="../view/category?id=<%=CategoryFooterMenuList.get(j).getId()%>"><%=CategoryFooterMenuList.get(j).getTitle()%></a></li>
									<%
										count++;
											}
									%>
							...
							<div class="box-content">
								<ul class="list bullet text-fill">
									<li><a href="javascript:void(0);"><i
											class="fa fa-map-marker">&nbsp;</i>&nbsp;Địa chỉ:
											${ContractInformation.address}</a></li>
									<li><a href="javascript:void(0);"><i
											class="fa fa-phone">&nbsp;</i>&nbsp;Điện thoại:
											${ContractInformation.phone}</a></li>
									<li><a href="javascript:void(0);"><i class="fa fa-fax">&nbsp;</i>&nbsp;Fax:
											${ContractInformation.fax}</li>
									<li><a href="javascript:void(0);"><i
											class="fa fa-envelope">&nbsp;</i>&nbsp; Email:
											${ContractInformation.email}</li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="copyright pull-left">
						Shoes Shop - Copyright &copy; 2017. Phát triển bởi <a href=""
							title="Team01" target="_blank">Team 9</a>
					</div>
				</div>
			</div>
		</div>
