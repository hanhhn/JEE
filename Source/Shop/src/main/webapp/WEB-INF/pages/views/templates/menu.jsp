...
$(window).bind('scroll', function () {
    if ($(window).scrollTop() > 150) {
        $('#pav-mainnav .inner').css({"position":"fixed", "top":"0", "width":"inherit"});
    } else {
        $('#pav-mainnav .inner').css("position","initial");
    }
});
									...
									<div class="navbar-header">
										...
										<div class="collapse navbar-collapse navbar-ex1-collapse">
											<ul class="nav navbar-nav megamenu">
												<li class="home"><a href="../view/home"><span
														class="menu-title">Trang chủ</span></a></li>
												<li><a href="../view/about"><span
														class="menu-title">Giới thiệu</span></a></li>
												<li class=" aligned-left parent dropdown "><a
													href="../view/category" class="dropdown-toggle"
													data-toggle="dropdown"><span class="menu-title">Sản
															phẩm</span><b class="caret"></b></a>
																		...
																		<div class="pavo-widget" id="pavowid-50">
																			<div class="pavo-widget" id="pavowid-790836132">
																				<div class="widget-heading box-heading">
																					<a
																						href="../view/category?id=<%=CategoryMenuList.get(i).getId()%>">
																				...
																				<div class="">
																					<ul>
																						...
																						%>
																						<li><a
																							href="../view/category?id=<%=CategoryMenuList.get(j).getId()%>"><span
																								class="title"><%=CategoryMenuList.get(j).getTitle()%></span></a></li>
																						<%
																							}
																						%>
																						<%
												...
												<li class=" aligned-left parent dropdown "><a
													href="../view/sale" class="dropdown-toggle"
													data-toggle="dropdown"><span class="menu-title">Khuyến
															mãi</span><b class="caret"></b></a>
																			...
																			<div class="pavo-widget">
																				<div class="widget-product-list sidebar">
																					<div class="widget-inner">
																						...
																						%>
																						<div
																							class="w-product clearfix col-lg-12 col-md-12 col-sm-12 col-xs-12">
																							<div class="product-block">
																								<div class="image">
																									<a class="img"
																										href="../view/product?id=<%=SaleList.get(i).getId()%>"><img
																										width="50px" height="50px"
																										src="../image/product/<%=SaleList.get(i).getImages().get(0)%>"
																										alt="<%=SaleList.get(i).getTitle()%>"
																								...
																								<div class="product-meta">
																									...
																									<h3 class="name">
																										<a
																											href="../view/product?id=<%=SaleList.get(i).getId()%>"><%=SaleList.get(i).getTitle()%></a>
																									</h3>
																								</div>
																							</div>
																						</div>
												...
												<li class=""><a href="../view/news"><span
														class="menu-title">Tin tức</span></a></li>
												<li class=""><a href="../view/contact"><span
				...
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 hidden-xs">
					<div class="search-box search-inline">
						<div class="input-group">
							<input id="txtSearchValueInput" type="text" name="search"
								placeholder="Tìm kiếm..." value=""
								class="input-search form-control" /> <span
								class="input-group-addon">
								<button class="button-search fa fa-search" type="button"
									onclick="goToSearchResultSport();"></button>
							</span>
						</div>
					</div>
				</div>
