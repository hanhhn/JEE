								...
								<div class="row contact-content">
									<div class="col-xs-12" id="InformContentCartPage">
										...
										<div class="alert alert-success">
											...
											<strong>Thông báo! </strong> Đang có 0 sản phẩm trong giỏ
											hàng của bạn. <a href="../view/home" class="alert-link">Tiếp
												tục mua sắm</a>
										</div>
										<%
											}
											...
											<fieldset class="">
												<div class="content">
													<div class="form-group required">
														<label class="col-sm-3 control-label" for="input-name">Tên
															của bạn</label>
														<div class="col-sm-9">
															<input type="text" name="name" value="" id="input-name"
																class="form-control" placeholder="Ví dụ: Lâm Xung" />
														</div>
													</div>
													<div class="form-group required">
														<label class="col-sm-3 control-label" for="input-email">Số
															điện thoại</label>
														<div class="col-sm-9">
															<input type="text" name="email" value="" id="input-phone"
																class="form-control" placeholder="Ví dụ: 0979 79 79 79" />
														</div>
													</div>
													<div class="form-group required">
														<label class="col-sm-3 control-label" for="input-email">Địa
															chỉ email</label>
														<div class="col-sm-9">
															<input type="text" name="email" value="" id="input-email"
																class="form-control"
																placeholder="Ví dụ: support@sportshop.com.vn" />
														</div>
													</div>
													<div class="form-group required">
														<label class="col-sm-3 control-label" for="input-email">Tỉnh/Thành
															phố</label>
														<div class="col-sm-9">
															<input type="text" name="email" value=""
																id="input-province" class="form-control"
													...
													<div class="form-group required">
														...
														<div class="col-sm-9">
															<input type="text" name="email" value=""
																id="input-district" class="form-control"
													...
													<div class="form-group required">
														...
														<div class="col-sm-9">
															<input type="text" name="email" value="" id="input-wards"
																class="form-control" placeholder="Ví dụ: 12" />
														</div>
													</div>
													<div class="form-group required">
														<label class="col-sm-3 control-label" for="input-email">Số
														...
														<div class="col-sm-9">
															<input type="text" name="email" value=""
																...
																placeholder="Ví dụ: 362 Phan Huy Ích" />
														</div>
													</div>
												</div>
