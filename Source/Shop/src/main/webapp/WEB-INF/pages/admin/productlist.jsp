...
<body>
    ...
    function deleteProduct() {
    	...
    	$.post("../admin/deleteproduct", {
    		...
    		console.log(EX);
    		/*
    		 * var message = ' <div class="alert alert-danger"> <button
    		 * type="button" class="close" data-dismiss="alert"
    		 * aria-hidden="true">&times;</button><strong>Cảnh báo! </strong> Đã
    		 * xảy ra lỗi trong quá trình tạo mới sản phẩm. Vui lòng thử lại.
    		 * </div>'; $('#InformContentCartPage').append(message);
    		 */
    	});
    };
    </script>
