...
<nav class="navbar navbar-default navbar-static-top" role="navigation"
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="../admin/productlist">Admin
			Sportshop</a>
	</div>
	<!-- /.navbar-header -->
	...
	<ul class="nav navbar-top-links navbar-right">
		...
		<li class="dropdown"><a class="dropdown-toggle"
			...
			<ul class="dropdown-menu dropdown-alerts">
				...
				<li><a href="#">
						<div>
							<i class="fa fa-twitter fa-fw"></i> 3 người theo dõi <span
								class="pull-right text-muted small">12 phút trước</span>
						</div>
				</a></li>
				<li class="divider"></li>
				<li><a href="#">
						<div>
							<i class="fa fa-envelope fa-fw"></i> Tin nhắn đã gửi <span
								class="pull-right text-muted small">4 phút trước</span>
						</div>
				</a></li>
				<li class="divider"></li>
				<li><a class="text-center" href="#"> <strong>Xem
							tất cả thông báo</strong> <i class="fa fa-angle-right"></i>
				</a></li>
	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li><a href="#"><i class="fa fa-book fa-fw"></i> Sản phẩm <span
						class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li><a href="../admin/productlist">Danh sách sản phẩm</a></li>
						<li><a href="../admin/newproductpage">Thêm mới sản phẩm</a></li>
					</ul></li>
				<li>
				...
				<li><a href="~/admin/user"><i
						class="fa fa-bar-chart-o fa-fw"></i> Người dùng<span
						class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li><a href="../admin/user">Danh sách người dùng</a></li>
						<li><a href="../admin/addnewuser">Thêm người dùng</a></li>
